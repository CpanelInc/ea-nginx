...
- Explicitly set `proxy_http_version 1.0;`
  ...
  - **Note:** nginx 1.29.7+ changed the compile-time default from 1.0 to 1.1 (EA4-257), so
    this must be set explicitly - do not rely on the default.
